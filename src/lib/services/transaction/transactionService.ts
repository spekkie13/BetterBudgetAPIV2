...
import type { TxnKind, CreateTxnInput, CreateTransferInput, UpdateTxnInput } from './txTypes';
...
//         // Fallback to a wide query by category would need a repo; omitted to match the current usage scope.
