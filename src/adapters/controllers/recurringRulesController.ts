    ...
    return {
        async listRules(teamId: number) {
            ...
            return items.length > 0 ?
                ...
                new ApiDataResponse({ data: teamId, status: 404, message: 'no rules found' });
        },
        ...
        async getRule(teamId: number, id: number | undefined) {
            ...
            if (id === undefined) {
                ...
                return row ?
                    ...
                    new ApiDataResponse({ data: teamId, status: 404, message: 'Rule not found' });
            }
        ...
        async createRule(teamId: number, body: RecurringRulesInsert) {
            ...
            return created ?
                ...
                new ApiDataResponse({ data: body, status: 422, message: 'Rule could not be created'})
        },
        ...
        async updateRule(teamId: number, id: number, body: RecurringRulesPatch) {
            ...
            return updated ?
                ...
                new ApiDataResponse({ data: body, status: 422, message: 'Rule could not be updated'})
        },

        async deleteRule(teamId: number, id: number) {
            await svc.deleteByIdTeam(teamId, id);
            return new ApiDataResponse({ status: 204, data: null, message: 'Rule deleted successfully'});
        },
    };
}
