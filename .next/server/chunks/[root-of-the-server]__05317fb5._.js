...
async function POST(req) {
    ...
    try {
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.create({
            data: category
        });
...
async function PATCH(req) {
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.update({
        where: {
            id: data.id
        },
        data
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05317fb5._.js.map